...
| **Atoms** | **Badge** | IUCN status badges (`CR`, `EN`, `VU`, `NT`, `LC`, `EW`, `EX`), category tags, and vibe pill tags | **✅ Ready** | [`Design System/Badge/Badge.tsx`](file:///Users/shreyas/AI-Experiments/wildatlas-india/Design%20System/Badge/Badge.tsx) |
