...
export const typographyScale = [
  ...
  {
    role: "Subtitle — Scientific Name",
    font: "Manrope (Sans)",
    size: "14px / 12px (text-sm / text-xs)",
    weight: "Italic Regular (400)",
    sample: "Panthera tigris tigris · Psilopogon haemacephalus",
    class: "text-sm italic text-zinc-500 font-sans",
  },
  {
    role: "Tags & Mono Kicker",
    font: "JetBrains Mono",
    size: "12px / 10px (text-xs / text-[10px])",
    weight: "Semibold / Bold (600/700)",
    sample: "SHIFT + V · CR · EN · DID YOU KNOW · 44km²",
    class: "font-mono text-xs font-semibold uppercase tracking-wider text-zinc-800",
  },
  {
    role: "Map Label — GIS Feature",
    font: "JetBrains Mono",
    size: "10px / 9px (text-[10px] / text-[9px])",
    weight: "Semibold / Regular (600 / 400)",
    sample: "Kaziranga NP · KERALA · Gir Sanctuary",
    class: "font-mono text-[10px] font-semibold text-zinc-700 tracking-tight",
  },
  {
    role: "Attribution — Source & Photo Credit",
    font: "Manrope (Sans)",
    size: "11px / 10px (text-[11px] / text-[10px])",
    weight: "Regular (400)",
    sample: "Photo: CC-BY-SA 4.0 via Wikimedia Commons · Source: GBIF / IUCN",
    class: "text-[11px] text-zinc-400 leading-normal",
  },
];
